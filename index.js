...
app.post('/razorpay-webhook', async (req, res) => {
    const webhookBody = req.rawBody; // Raw body captured by middleware
    ...
    try {
        ...
        const expectedSignature = crypto
            ...
            .update(webhookBody) // Use raw body here
            .digest('hex');

        if (expectedSignature === webhookSignature) {
            const event = JSON.parse(webhookBody); // Parse raw body into JSON
